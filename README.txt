...
Once the files are available in the working directory, running the command `python main.py` would run all the experiments and generate the figures in the scripts directory.
